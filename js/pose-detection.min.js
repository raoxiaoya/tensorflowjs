...
!function(t, e) {
    ...
    var c = ["nose", "left_eye", "right_eye", "left_ear", "right_ear", "left_shoulder", "right_shoulder", "left_elbow", "right_elbow", "left_wrist", "right_wrist", "left_hip", "right_hip", "left_knee", "right_knee", "left_ankle", "right_ankle"]
      , p = ["nose", "left_eye_inner", "left_eye", "left_eye_outer", "right_eye_inner", "right_eye", "right_eye_outer", "left_ear", "right_ear", "mouth_left", "mouth_right", "left_shoulder", "right_shoulder", "left_elbow", "right_elbow", "left_wrist", "right_wrist", "left_pinky", "right_pinky", "left_index", "right_index", "left_thumb", "right_thumb", "left_hip", "right_hip", "left_knee", "right_knee", "left_ankle", "right_ankle", "left_heel", "right_heel", "left_foot_index", "right_foot_index"]
      , d = {
      ...
      , m = [[0, 1], [0, 2], [1, 3], [2, 4], [5, 6], [5, 7], [5, 11], [6, 8], [6, 12], [7, 9], [8, 10], [11, 12], [11, 13], [12, 14], [13, 15], [14, 16]]
      , g = [[0, 1], [0, 4], [1, 2], [2, 3], [3, 7], [4, 5], [5, 6], [6, 8], [9, 10], [11, 12], [11, 13], [11, 23], [12, 14], [14, 16], [12, 24], [13, 15], [15, 17], [16, 18], [16, 20], [15, 17], [15, 19], [15, 21], [16, 22], [17, 19], [18, 20], [23, 25], [23, 24], [24, 26], [25, 27], [26, 28], [27, 29], [28, 30], [27, 31], [28, 32], [29, 31], [30, 32]];
    function y(t) {
        ...
        return u(this, void 0, void 0, (function() {
            ...
            return l(this, (function(r) {
                ...
                case 2:
                    ...
                    e.height = y(t.height),
                    i = e.getContext("2d"),
                    t instanceof ImageData ? i.putImageData(t, 0, 0) : i.drawImage(t, 0, 0),
                    r.label = 3;
                case 3:
                    return [2, e]
                }
    ...
    function x(t) {
        return u(this, void 0, void 0, (function() {
            ...
            return l(this, (function(u) {
                switch (u.label) {
                case 0:
                    return t instanceof n.Tensor ? (e = t.shape.slice(0, 2),
                    i = e[0],
                    r = e[1],
                    o = ImageData.bind,
                    [4, n.browser.toPixels(t)]) : [3, 2];
                case 1:
    ...
    function w(t) {
        return u(this, void 0, void 0, (function() {
            ...
            return l(this, (function(r) {
                switch (r.label) {
                case 0:
                    return t instanceof SVGImageElement || t instanceof OffscreenCanvas ? [4, v(t)] : [3, 2];
                case 1:
                    return i = r.sent(),
                    [3, 3];
                case 2:
    ...
    function k(t) {
        if (t < 0 || t >= 256)
            throw new Error("Mask value must be in range [0, 255] but got ".concat(t));
            ...
            return u(this, void 0, void 0, (function() {
                ...
                return l(this, (function(a) {
                    ...
                    case 0:
                        ...
                        t instanceof n.Tensor ? (o = ImageData.bind,
                        [4, n.browser.toPixels(t)]) : [3, 2];
                    case 1:
                        return r = new (o.apply(ImageData, [void 0, a.sent(), t.shape[1], t.shape[0]])),
                        [3, 3];
                    case 2:
                        r = t,
                        a.label = 3;
            ...
            return l(this, (function(i) {
                ...
                case 0:
                    return e = function(t) {
                        ...
                        null == e.enableSegmentation && (e.enableSegmentation = b.enableSegmentation),
                        null == e.enableSmoothing && (e.enableSmoothing = b.enableSmoothing),
                        null == e.smoothSegmentation && (e.smoothSegmentation = b.smoothSegmentation),
    ...
    function O(t, e, n) {
        return I(n, "inputResolution"),
        [1 / n.width * t[0][0] * e.width, 1 / n.height * t[0][1] * e.width, t[0][3] * e.width, 1 / n.width * t[1][0] * e.height, 1 / n.height * t[1][1] * e.height, t[1][3] * e.height, 0, 0]
    }
    function I(t, e) {
    ...
    function R(t, e, n) {
        var i = (e + 1) % 4
          ...
          , s = (n + 2) % 4
          , u = (n + 3) % 4;
        return E(t, i, r, o, a, s, u) + E(t, r, o, i, a, s, u) + E(t, o, i, r, a, s, u)
    }
    function L(t, e, n) {
        void 0 === n && (n = {
            ignoreRotation: !1
        ...
        for (var i = [], r = 0, o = t; r < o.length; r++) {
            ...
            c = c * e.width + e.xCenter,
            p = p * e.height + e.yCenter;
            var d = a.z * e.width
              , f = s({}, a);
            f.x = c,
            f.y = p,
    ...
    function B(t, e) {
        var i = function(t, e, n, i) {
            var r = e - t
              , o = i - n;
            if (0 === r)
                throw new Error("Original min and max are both ".concat(t, ", range cannot be 0."));
            var a = o / r;
            return {
                scale: a,
                offset: n - t * a
    ...
    function V(t, e, i) {
        var r, o, a, s, u, l, h, c, p, d, f, m, g, y, v = e.outputTensorSize, x = e.keepAspectRatio, w = e.borderMode, k = e.outputTensorFloatRange, b = F(t), M = function(t, e) {
            return e ? {
            ...
            I(e, "targetSize"),
            I(t, "roi");
            var o, a, s = i / r, u = t.height / t.width, l = 0, h = 0;
            return s > u ? (o = t.width,
            a = t.width * s,
            h = (1 - u / s) / 2) : (o = t.height / s,
            a = t.height,
            l = (1 - s / u) / 2),
            t.width = o,
            t.height = a,
        ...
        y[1] = -l * p * m,
        y[2] = 0,
        y[3] = (-.5 * u * c * h + .5 * l * p + d) * m,
        y[4] = u * p * h * g,
        y[5] = l * c * g,
        y[6] = 0,
        y[7] = (-.5 * l * c - .5 * u * p * h + f) * g,
        y[8] = 0,
        y[9] = 0,
        y[10] = u * m,
        y[11] = 0,
        ...
        return {
            imageTensor: n.tidy((function() {
                var e = z(t)
                  ...
                  , o = n.image.transform(n.expandDims(n.cast(e, "float32")), i, "bilinear", r, 0, [v.height, v.width]);
    ...
    function N(t) {
        return n.tidy((function() {
            var e = function(t) {
                return n.tidy((function() {
                    return [n.slice(t, [0, 0, 0], [1, -1, 1]), n.slice(t, [0, 0, 1], [1, -1, -1])]
                }
                ))
            }(t)
              , i = e[0]
    ...
    function K(t) {
        for (var e = {
            ...
            r = Math.min(r, s.y),
            o = Math.max(o, s.y),
            e.locationData.relativeKeypoints.push({
                x: s.x,
                y: s.y
            })
        }
    ...
    function H(t, e, i) {
        return u(this, void 0, void 0, (function() {
            var r, o, a, u, h, c, p, d, f, m, g, y, v, x, w, k, b, M, S, T, P, F, _, z;
            return l(this, (function(l) {
                switch (l.label) {
                case 0:
                    if (r = n.squeeze(e, [0]),
                    ...
                    h = o[2],
                    t.length !== h)
                        throw new Error("Expected heatmap to have same number of channels as the number of landmarks. But got landmarks length: " + "".concat(t.length, ", heatmap length: ").concat(h));
                    return c = [],
                    [4, r.buffer()];
                case 1:
                    for (p = l.sent(),
                        ...
                        !(g < 0 || g >= u || y < 0 || g >= a)) {
                            ...
                            F = k; F < b; ++F)
                                for (_ = x; _ < w; ++_)
                                    ...
                                    S += _ * z,
                                    T += F * z;
                            P >= i.minConfidenceToRefine && M > 0 && (m.x = S / u / M,
                            m.y = T / a / M)
                        }
                    return r.dispose(),
                    [2, c]
    ...
    function X(t, e, i) {
        return "webgl" === n.getBackend() ? function(t, e, i) {
        ...
        }(t, e, i) : n.tidy((function() {
            var r = n.sub(e, .5)
              , o = n.square(r)
              , a = n.sub(1, n.minimum(1, n.mul(o, n.add(5.68842, n.mul(o, n.add(-.748699, n.mul(o, n.add(-57.8051, n.mul(o, n.add(291.309, n.mul(o, -624.717)))))))))));
            return n.add(e, n.mul(n.sub(t, e), n.mul(a, i.combineWithPreviousRatio)))
        }
        ))
    }
    function Y(t, e, i) {
            ...
            return l(this, (function(l) {
                ...
                case 0:
                    ...
                    a = function(t, e, i) {
                        return n.tidy((function() {
                            var r, o, a, s;
                            i.reverseOutputOrder ? (o = n.squeeze(n.slice(t, [0, i.boxCoordOffset + 0], [-1, 1])),
                            r = n.squeeze(n.slice(t, [0, i.boxCoordOffset + 1], [-1, 1])),
                            s = n.squeeze(n.slice(t, [0, i.boxCoordOffset + 2], [-1, 1])),
                            a = n.squeeze(n.slice(t, [0, i.boxCoordOffset + 3], [-1, 1]))) : (r = n.squeeze(n.slice(t, [0, i.boxCoordOffset + 0], [-1, 1])),
                            o = n.squeeze(n.slice(t, [0, i.boxCoordOffset + 1], [-1, 1])),
                            a = n.squeeze(n.slice(t, [0, i.boxCoordOffset + 2], [-1, 1])),
                            s = n.squeeze(n.slice(t, [0, i.boxCoordOffset + 3], [-1, 1]))),
                            o = n.add(n.mul(n.div(o, i.xScale), e.w), e.x),
                            r = n.add(n.mul(n.div(r, i.yScale), e.h), e.y),
                            i.applyExponentialOnBoxSize ? (a = n.mul(n.exp(n.div(a, i.hScale)), e.h),
                            s = n.mul(n.exp(n.div(s, i.wScale)), e.w)) : (a = n.mul(n.div(a, i.hScale), e.h),
                            s = n.mul(n.div(s, i.wScale), e.h));
                            var u = n.sub(r, n.div(a, 2))
                              , l = n.sub(o, n.div(s, 2))
                              , h = n.add(r, n.div(a, 2))
                              , c = n.add(o, n.div(s, 2))
                              , p = n.concat([n.reshape(u, [i.numBoxes, 1]), n.reshape(l, [i.numBoxes, 1]), n.reshape(h, [i.numBoxes, 1]), n.reshape(c, [i.numBoxes, 1])], 1);
                            if (i.numKeypoints)
                                for (var d = 0; d < i.numKeypoints; ++d) {
                                    var f = i.keypointCoordOffset + d * i.numValuesPerKeypoint
                                      , m = void 0
                                      , g = void 0;
                                    i.reverseOutputOrder ? (m = n.squeeze(n.slice(t, [0, f], [-1, 1])),
                                    g = n.squeeze(n.slice(t, [0, f + 1], [-1, 1]))) : (g = n.squeeze(n.slice(t, [0, f], [-1, 1])),
                                    m = n.squeeze(n.slice(t, [0, f + 1], [-1, 1])));
                                    var y = n.add(n.mul(n.div(m, i.xScale), e.w), e.x)
                                      , v = n.add(n.mul(n.div(g, i.yScale), e.h), e.y);
                                    p = n.concat([p, n.reshape(y, [i.numBoxes, 1]), n.reshape(v, [i.numBoxes, 1])], 1)
                                }
                            return p
                        }
                        ))
                    ...
                    s = n.tidy((function() {
                        var t = r;
                        return i.sigmoidScore ? (null != i.scoreClippingThresh && (t = n.clipByValue(r, -i.scoreClippingThresh, i.scoreClippingThresh)),
                        t = n.sigmoid(t)) : t
                    }
                    )),
                    [4, W(a, s, i)];
        ...
        return u(this, void 0, void 0, (function() {
            ...
            return l(this, (function(l) {
                ...
                case 2:
                    for (o = l.sent(),
                    a = 0; a < n.numBoxes; ++a)
                        if (!(null != n.minScoreThresh && o[a] < n.minScoreThresh || (s = a * n.numCoords,
                        u = Q(r[s + 0], r[s + 1], r[s + 2], r[s + 3], o[a], n.flipVertically, a),
                        (h = u.locationData.relativeBoundingBox).width < 0 || h.height < 0))) {
                            if (n.numKeypoints > 0)
                                ...
                                d = 0; d < p; d += n.numValuesPerKeypoint)
    ...
    function tt(t, e) {
        return t.map((function(t) {
            ...
            return null != t.z && (t.z = t.z / e.width),
            n
        }
        ))
    }
    var et = function() {
        ...
        return t.prototype.apply = function(t, e) {
            var n;
            return this.initialized ? n = null == e ? this.storedValue + this.alpha * (t - this.storedValue) : this.storedValue + this.alpha * e * Math.asinh((t - this.storedValue) / e) : (n = t,
            this.initialized = !0),
            this.rawValue = t,
            this.storedValue = n,
            n
      ...
      , nt = function() {
        ...
        return t.prototype.apply = function(t, e, n) {
            ...
            if (this.lastTimestamp >= i)
                return t;
            0 !== this.lastTimestamp && 0 !== i && (this.frequency = 1 / (1e-6 * (i - this.lastTimestamp))),
            this.lastTimestamp = i;
            var r = this.x.hasLastRawValue() ? (t - this.x.lastRawValue()) * n * this.frequency : 0
      ...
      , it = function() {
        ...
        return t.prototype.apply = function(t, e, n) {
            ...
            return t.map((function(t, n) {
                ...
                return null != t.z && (o.z = i.zFilters[n].apply(t.z, e, r)),
                o
            }
            ))
        }
      ...
      , rt = function() {
        ...
        return t.prototype.apply = function(t, e, n) {
            ...
            if (-1 === this.lastTimestamp)
                ...
                for (var o = t * n - this.lastValue * this.lastValueScale, a = r - this.lastTimestamp, s = o, u = a, l = (1 + this.window.length) * (1e6 / 30), h = 0, c = this.window; h < c.length; h++) {
                    var p = c[h];
                    if (u + p.duration > l)
                        break;
                    s += p.distance,
      ...
      , ot = function() {
        ...
        return t.prototype.apply = function(t, e, n) {
            ...
            return this.initializeFiltersIfEmpty(t),
            t.map((function(t, n) {
                var o = s(s({}, t), {
                    x: i.xFilters[n].apply(t.x, e, r),
                    y: i.yFilters[n].apply(t.y, e, r)
        ...
        function t(t) {
            if (null != t.velocityFilter)
                ...
                if (null == t.oneEuroFilter)
                    throw new Error("Either configure velocityFilter or oneEuroFilter, but got " + "".concat(t, "."));
      ...
      , st = function() {
        ...
        return t.prototype.apply = function(t) {
            ...
            for (var n = [], i = 0; i < t.length; ++i) {
                var r = t[i]
                  , o = s({}, r);
                o.score = this.visibilityFilters[i].apply(r.score),
                n.push(o)
            }
            return n
        }
    ...
    var Ft = function() {
        function t(t, e, i, r, o, a) {
            ...
            this.anchors = function(t) {
                null == t.reduceBoxesInLowestLayer && (t.reduceBoxesInLowestLayer = !1),
                null == t.interpolatedScaleAspectRatio && (t.interpolatedScaleAspectRatio = 1),
                ...
                for (var e = [], n = 0; n < t.numLayers; ) {
                    for (var i = [], r = [], o = [], a = [], s = n; s < t.strides.length && t.strides[s] === t.strides[n]; ) {
                        ...
                        if (0 === s && t.reduceBoxesInLowestLayer)
                            ...
                            for (var l = 0; l < t.aspectRatios.length; ++l)
                                o.push(t.aspectRatios[l]),
                                a.push(u);
                            if (t.interpolatedScaleAspectRatio > 0) {
                                var h = s === t.strides.length - 1 ? 1 : D(t.minScale, t.maxScale, s + 1, t.strides.length);
                    ...
                    if (t.featureMapHeight.length > 0)
                        d = t.featureMapHeight[n],
                        f = t.featureMapWidth[n];
                    else {
                        var m = t.strides[n];
            ...
            var s = n.tensor1d(this.anchors.map((function(t) {
                return t.width
            }
            )))
              , u = n.tensor1d(this.anchors.map((function(t) {
                return t.height
            }
            )))
              , l = n.tensor1d(this.anchors.map((function(t) {
                return t.xCenter
            }
            )))
              , h = n.tensor1d(this.anchors.map((function(t) {
                return t.yCenter
            }
            )));
            this.anchorTensor = {
            ...
            this.prevFilteredSegmentationMask = this.enableSegmentation ? n.tensor2d([], [0, 0]) : null
        }
        return t.prototype.estimatePoses = function(t, e, i) {
            return u(this, void 0, void 0, (function() {
                var r, o, a, u, h, c, d, f, m, g, y, v, x, w, k, b, M, S, T, P, _, O, I;
                return l(this, (function(l) {
                    switch (l.label) {
                    case 0:
                        return r = function(t) {
                            var e;
                            if (null == (e = null == t ? ht : s({}, t)).maxPoses && (e.maxPoses = 1),
                            e.maxPoses <= 0)
                                throw new Error("Invalid maxPoses ".concat(e.maxPoses, ". Should be > 0."));
                            if (e.maxPoses > 1)
                        ...
                        this.timestamp = null != i ? 1e3 * i : q(t) ? 1e6 * t.currentTime : null,
                        o = F(t),
                        a = n.tidy((function() {
                    ...
                    case 3:
                        ...
                        S = this.smoothSegmentation && null != v ? this.poseSegmentationFiltering(v) : v,
                        null != (T = null != w ? j(w, o) : null) && T.forEach((function(t, e) {
                            t.name = p[e]
                        }
                        )),
                        ...
                        null !== S && (O = n.tidy((function() {
                            var t = n.expandDims(S, 2)
                              , e = n.pad(t, [[0, 0], [0, 0], [0, 1]]);
                            return n.mirrorPad(e, [[0, 0], [0, 0], [0, 2]], "symmetric")
                        }
                        )),
        ...
        t.prototype.poseSegmentationFiltering = function(t) {
            ...
            return 0 === e.size ? this.prevFilteredSegmentationMask = t : (this.prevFilteredSegmentationMask = X(e, t, St),
            n.dispose(t)),
            n.dispose(e),
        ...
        t.prototype.dispose = function() {
            ...
            n.dispose([this.anchorTensor.x, this.anchorTensor.y, this.anchorTensor.w, this.anchorTensor.h, this.prevFilteredSegmentationMask])
        }
        ,
        t.prototype.reset = function() {
            this.regionOfInterest = null,
            this.enableSegmentation && (n.dispose(this.prevFilteredSegmentationMask),
        ...
        t.prototype.detectPose = function(t) {
            return u(this, void 0, void 0, (function() {
                ...
                return l(this, (function(l) {
                    ...
                    case 1:
                        return 0 === (h = l.sent()).length ? (n.dispose([i, o, u, s]),
                        [2, h]) : [4, U(h, this.maxPoses, pt)];
                    case 2:
                        return c = l.sent(),
                        p = function(t, e) {
                            void 0 === t && (t = []);
            ...
            return u(this, void 0, void 0, (function() {
                ...
                return l(this, (function(l) {
                    ...
                    case 0:
                        ...
                        return h = ["ld_3d", "output_poseflag", "activation_heatmap", "world_3d"],
                    ...
                    case 1:
                        return null == (p = l.sent()) ? (n.dispose(c),
                        n.dispose(o),
                        [2, null]) : (d = p.landmarks,
                        f = p.auxiliaryLandmarks,
                        m = p.poseScore,
                        g = p.worldLandmarks,
                        y = p.segmentationMask,
                        [4, this.poseLandmarksAndSegmentationInverseProjection(i, t, a, u, d, f, g, y)]);
                    case 2:
                        return v = l.sent(),
                        n.dispose(c),
                        n.dispose(o),
        ...
        ,
        t.prototype.poseLandmarksAndSegmentationInverseProjection = function(t, e, i, r, o, a, h, c) {
            return u(this, void 0, void 0, (function() {
                var u, p, d, f, m, g;
                return l(this, (function(l) {
                    return u = G(o, i),
                    ...
                    g = null,
                    this.enableSegmentation && (g = n.tidy((function() {
                        var e = c.shape
                          , i = e[0]
                          , o = e[1]
                          , a = function(t) {
                            ...
                            e[2][3] = -R(t, 3, 2),
                            e[3][3] = R(t, 3, 3);
                            for (var n = t[0][0] * e[0][0] + t[1][0] * e[0][1] + t[2][0] * e[0][2] + t[3][0] * e[0][3], i = 0; i < e.length; i++)
                          ...
                          , u = [1, i, o, 1];
                        return n.squeeze(n.image.transform(n.reshape(c, u), s, "bilinear", "constant", 0, [t.height, t.width]), [0, 3])
                    }
                    )),
                    n.dispose(c)),
                    [2, {
            ...
            return u(this, void 0, void 0, (function() {
                ...
                return l(this, (function(l) {
                    ...
                    case 0:
                        ...
                        [4, i.data()];
                    case 1:
                        return (u = l.sent()[0]) < .5 ? [2, null] : [4, $(e, gt)];
                    case 2:
                    ...
                    case 4:
                        ...
                        g = this.enableSegmentation ? function(t, e, i) {
                            return n.tidy((function() {
                                var r = n.squeeze(t, [0])
                                  , o = r.shape[2];
                                if (1 === o) {
                                    ...
                                    var s = i ? n.image.resizeBilinear(a, [i.height, i.width]) : a;
                                    return n.squeeze(s, [2])
                                }
                                throw new Error("Unsupported number of tensor channels ".concat(o))
                            }
                            ))
                        }(a, Mt) : null,
                        [2, {
        ...
        t.prototype.poseLandmarkFiltering = function(t, e, n, i) {
            ...
            if (null != this.timestamp && this.enableSmoothing) {
                ...
                null == this.visibilitySmoothingFilterActual && (this.visibilitySmoothingFilterActual = new st(xt)),
                r = this.visibilitySmoothingFilterActual.apply(t),
                null == this.visibilitySmoothingFilterAuxiliary && (this.visibilitySmoothingFilterAuxiliary = new st(xt)),
                o = this.visibilitySmoothingFilterAuxiliary.apply(e),
                a = this.visibilitySmoothingFilterActual.apply(n),
                null == this.landmarksSmoothingFilterActual && (this.landmarksSmoothingFilterActual = new at(wt)),
                r = this.landmarksSmoothingFilterActual.apply(r, this.timestamp, i, !0, s),
                null == this.landmarksSmoothingFilterAuxiliary && (this.landmarksSmoothingFilterAuxiliary = new at(kt)),
                o = this.landmarksSmoothingFilterAuxiliary.apply(o, this.timestamp, i, !0, s),
                null == this.worldLandmarksSmoothingFilterActual && (this.worldLandmarksSmoothingFilterActual = new at(bt)),
                a = this.worldLandmarksSmoothingFilterActual.apply(n, this.timestamp)
            } else
                r = t,
                o = e,
                a = n;
        ...
        return u(this, void 0, void 0, (function() {
            ...
            return l(this, (function(l) {
                ...
                case 0:
                    return e = function(t) {
                        var e = s({}, null == t ? lt : t);
                        if (null == e.enableSmoothing && (e.enableSmoothing = lt.enableSmoothing),
                        null == e.enableSegmentation && (e.enableSegmentation = lt.enableSegmentation),
                        null == e.smoothSegmentation && (e.smoothSegmentation = lt.smoothSegmentation),
                        null == e.modelType && (e.modelType = lt.modelType),
                        null == e.detectorModelUrl && (e.detectorModelUrl = lt.detectorModelUrl),
                    ...
                    n = "string" == typeof e.detectorModelUrl && e.detectorModelUrl.indexOf("https://tfhub.dev") > -1,
                    r = "string" == typeof e.landmarkModelUrl && e.landmarkModelUrl.indexOf("https://tfhub.dev") > -1,
                    [4, Promise.all([i.loadGraphModel(e.detectorModelUrl, {
                        fromTFHub: n
                    }), i.loadGraphModel(e.landmarkModelUrl, {
                        fromTFHub: r
                    })])];
                case 1:
                    return o = l.sent(),
                    a = o[0],
                    u = o[1],
                    [2, new Ft(a,u,e.enableSmoothing,e.enableSegmentation,e.smoothSegmentation,e.modelType)]
                }
            }
            ))
        }
    ...
    var zt, Ot, It = function() {
        function t(t) {
            !function(t) {
                if (t.maxTracks < 1)
                    throw new Error("Must specify 'maxTracks' to be at least 1, but " + "encountered ".concat(t.maxTracks));
                if (t.maxAge <= 0)
                    throw new Error("Must specify 'maxAge' to be positive, but " + "encountered ".concat(t.maxAge));
                if (void 0 !== t.keypointTrackerParams) {
                    if (t.keypointTrackerParams.keypointConfidenceThreshold < 0 || t.keypointTrackerParams.keypointConfidenceThreshold > 1)
                        throw new Error("Must specify 'keypointConfidenceThreshold' to be in the range [0, 1], but encountered " + "".concat(t.keypointTrackerParams.keypointConfidenceThreshold));
                    if (t.keypointTrackerParams.minNumberOfKeypoints < 1)
                        throw new Error("Must specify 'minNumberOfKeypoints' to be at least 1, but " + "encountered ".concat(t.keypointTrackerParams.minNumberOfKeypoints));
        ...
        return t.prototype.apply = function(t, e) {
            ...
            return this.assignTracks(t, n, e),
            this.updateTracks(e),
            t
        }
        ,
        ...
        t.prototype.createTrack = function(t, e, n) {
            ...
            return void 0 !== t.box && (i.box = s({}, t.box)),
            i
        }
        ,
        ...
        function e(e) {
            ...
            return n.keypointThreshold = e.keypointTrackerParams.keypointConfidenceThreshold,
        ...
        return a(e, t),
        e.prototype.computeSimilarity = function(t) {
            if (0 === t.length || 0 === this.tracks.length)
                return [[]];
        ...
        e.prototype.area = function(t) {
            var e = this
              ...
              , i = Math.min.apply(Math, h([1], n.map((function(t) {
                return t.x
            }
            )), !1))
              , r = Math.max.apply(Math, h([0], n.map((function(t) {
                return t.x
            }
            )), !1))
              , o = Math.min.apply(Math, h([1], n.map((function(t) {
                return t.y
            }
            )), !1));
            return (r - i) * (Math.max.apply(Math, h([0], n.map((function(t) {
                return t.y
            }
            )), !1)) - o)
        }
        ...
        if (function(t, e) {
            ...
            var u = (r.left_hip[0] + r.right_hip[0]) / 2
              ...
              , h = function(t, e, n, i, r) {
                for (var o = ["left_shoulder", "right_shoulder", "left_hip", "right_hip"], a = 0, s = 0, u = 0; u < o.length; u++) {
              ...
              , y = [u - (g = Math.min(g, Math.max(l, i.width - l, u, i.height - u))), l - g];
            if (g > Math.max(i.width, i.height) / 2)
                return Ut(null == t, i);
            var v = 2 * g;
            return {
                yMin: y[0] / i.height,
    ...
    function Ut(t, e) {
        var n, i, r, o;
        return t ? e.width > e.height ? (n = 1,
        i = e.height / e.width,
        r = 0,
        o = (e.width / 2 - e.height / 2) / e.width) : (n = e.width / e.height,
        i = 1,
        r = (e.height / 2 - e.width / 2) / e.height,
        o = 0) : e.width > e.height ? (n = e.width / e.height,
        i = 1,
        r = (e.height / 2 - e.width / 2) / e.height,
        o = 0) : (n = 1,
        i = e.height / e.width,
    ...
    function jt(e) {
        var n, i = null == e ? Bt : s({}, e);
        if (null == i.modelType)
            i.modelType = "SinglePose.Lightning";
        else if (Lt.indexOf(i.modelType) < 0)
            throw new Error("Invalid architecture ".concat(i.modelType, ". ") + "Should be one of ".concat(Lt));
        if (null == i.enableSmoothing && (i.enableSmoothing = !0),
        null != i.minPoseScore && (i.minPoseScore < 0 || i.minPoseScore > 1))
            throw new Error("minPoseScore should be between 0.0 and 1.0");
        if (null != i.multiPoseMaxDimension && (i.multiPoseMaxDimension % 32 != 0 || i.multiPoseMaxDimension < 32))
            throw new Error("multiPoseMaxDimension must be a multiple of 32 and higher than 0");
        if ("MultiPose.Lightning" === i.modelType && null == i.enableTracking && (i.enableTracking = !0),
        "MultiPose.Lightning" === i.modelType && !0 === i.enableTracking)
            if (null == i.trackerType && (i.trackerType = t.TrackerType.BoundingBox),
            i.trackerType === t.TrackerType.Keypoint)
                null != i.trackerConfig ? i.trackerConfig = function(t) {
                    var e = Ht(Nt, t);
                    e.keypointTrackerParams = s({}, Nt.keypointTrackerParams),
                    null != t.keypointTrackerParams && (null != t.keypointTrackerParams.keypointConfidenceThreshold && (e.keypointTrackerParams.keypointConfidenceThreshold = t.keypointTrackerParams.keypointConfidenceThreshold),
                    null != t.keypointTrackerParams.keypointFalloff && (e.keypointTrackerParams.keypointFalloff = t.keypointTrackerParams.keypointFalloff),
                    null != t.keypointTrackerParams.minNumberOfKeypoints && (e.keypointTrackerParams.minNumberOfKeypoints = t.keypointTrackerParams.minNumberOfKeypoints));
                    return e
                }(i.trackerConfig) : i.trackerConfig = Nt;
            else {
                if (i.trackerType !== t.TrackerType.BoundingBox)
                    throw new Error("Tracker type not supported by MoveNet");
                null != i.trackerConfig ? i.trackerConfig = (n = i.trackerConfig,
                Ht(qt, n)) : i.trackerConfig = qt
            }
        return i
    }
    function Ht(t, e) {
        ...
        return null != e.maxTracks && (n.maxTracks = e.maxTracks),
    ...
    var Gt = function() {
        function e(e, n) {
            ...
            "SinglePose.Lightning" === n.modelType ? (this.modelInputResolution.width = 192,
            this.modelInputResolution.height = 192) : "SinglePose.Thunder" === n.modelType && (this.modelInputResolution.width = 256,
            this.modelInputResolution.height = 256),
            this.multiPoseModel = "MultiPose.Lightning" === n.modelType,
            this.multiPoseModel || (this.keypointFilter = new it(Dt),
            this.cropRegionFilterYMin = new et(.9),
            this.cropRegionFilterXMin = new et(.9),
            this.cropRegionFilterYMax = new et(.9),
            this.cropRegionFilterXMax = new et(.9)),
            this.enableSmoothing = n.enableSmoothing,
            n.minPoseScore ? this.minPoseScore = n.minPoseScore : this.minPoseScore = .25,
            n.multiPoseMaxDimension ? this.multiPoseMaxDimension = n.multiPoseMaxDimension : this.multiPoseMaxDimension = 256,
            this.enableTracking = n.enableTracking,
            this.multiPoseModel && this.enableTracking && (n.trackerType === t.TrackerType.Keypoint ? this.tracker = new Ct(n.trackerConfig) : n.trackerType === t.TrackerType.BoundingBox && (this.tracker = new At(n.trackerConfig)),
            this.enableSmoothing && (this.keypointFilterMap = new Map))
        }
        return e.prototype.runSinglePersonPoseModel = function(t) {
            return u(this, void 0, void 0, (function() {
                var e, i, r, o, a;
                return l(this, (function(s) {
                    switch (s.label) {
                    case 0:
                        if (4 !== (e = this.moveNetModel.execute(t)).shape.length || 1 !== e.shape[0] || 1 !== e.shape[1] || 17 !== e.shape[2] || 3 !== e.shape[3])
                            throw e.dispose(),
                            new Error("Unexpected output shape from model: [".concat(e.shape, "]"));
                        return "webgpu" === n.getBackend() ? [3, 1] : (i = e.dataSync(),
                        [3, 3]);
                    case 1:
                        return [4, e.data()];
                    case 2:
                    ...
                    case 3:
                        ...
                        a = 0; a < 17; ++a)
                            ...
                            r.keypoints[a].score > .2 && (++o,
                            r.score += r.keypoints[a].score);
        ...
        e.prototype.runMultiPersonPoseModel = function(t) {
            return u(this, void 0, void 0, (function() {
                ...
                return l(this, (function(l) {
                    switch (l.label) {
                    case 0:
                        if (3 !== (e = this.moveNetModel.execute(t)).shape.length || 1 !== e.shape[0] || 56 !== e.shape[2])
                            throw e.dispose(),
                            new Error("Unexpected output shape from model: [".concat(e.shape, "]"));
                        return "webgpu" === n.getBackend() ? [3, 1] : (i = e.dataSync(),
                        [3, 3]);
            ...
            u(this, void 0, void 0, (function() {
                ...
                return l(this, (function(l) {
                    ...
                    case 0:
                        ...
                        null == t ? (this.reset(),
                        [2, []]) : (null == i ? q(t) && (i = 1e6 * t.currentTime) : i *= 1e3,
                        r = z(t),
                        o = F(r),
                        a = n.expandDims(r, 0),
        ...
        e.prototype.estimateSinglePose = function(t, e, i) {
            return u(this, void 0, void 0, (function() {
                ...
                return l(this, (function(l) {
                    switch (l.label) {
                    case 0:
                        return this.cropRegion || (this.cropRegion = Ut(null == this.cropRegion, e)),
                        r = n.tidy((function() {
                            var e = n.tensor2d([[u.cropRegion.yMin, u.cropRegion.xMin, u.cropRegion.yMax, u.cropRegion.xMax]])
                              , i = n.zeros([1], "int32")
                              , r = [u.modelInputResolution.height, u.modelInputResolution.width];
                            return n.cast(n.image.cropAndResize(t, e, i, r, "bilinear", 0), "int32")
                        }
                        )),
                        t.dispose(),
                    ...
                    case 1:
                        ...
                        for (a = 0; a < o.keypoints.length; ++a)
                            o.keypoints[a].y = this.cropRegion.yMin + o.keypoints[a].y * this.cropRegion.height,
                            o.keypoints[a].x = this.cropRegion.xMin + o.keypoints[a].x * this.cropRegion.width;
                        return null != i && this.enableSmoothing && (o.keypoints = this.keypointFilter.apply(o.keypoints, i, 1)),
                        s = Kt(this.cropRegion, o.keypoints, this.keypointIndexByName, e),
        ...
        e.prototype.estimateMultiplePoses = function(t, e, i) {
            return u(this, void 0, void 0, (function() {
                ...
                return l(this, (function(l) {
                    ...
                    case 0:
                        return 32,
                        e.width > e.height ? (o = this.multiPoseMaxDimension,
                        a = Math.round(this.multiPoseMaxDimension * e.height / e.width),
                        r = n.image.resizeBilinear(t, [a, o]),
                        u = o,
                        h = 32 * Math.ceil(a / 32),
                        s = n.pad(r, [[0, 0], [0, h - a], [0, 0], [0, 0]])) : (o = Math.round(this.multiPoseMaxDimension * e.width / e.height),
                        a = this.multiPoseMaxDimension,
                        r = n.image.resizeBilinear(t, [a, o]),
                        u = 32 * Math.ceil(o / 32),
                        h = a,
                        s = n.pad(r, [[0, 0], [0, 0], [0, u - o], [0, 0]])),
                        r.dispose(),
                        t.dispose(),
                        c = n.cast(s, "int32"),
                        s.dispose(),
                    ...
                    case 1:
                        ...
                        this.enableSmoothing)) {
                            for (f = 0; f < p.length; ++f)
                                this.keypointFilterMap.has(p[f].id) || this.keypointFilterMap.set(p[f].id, new it(Dt)),
        ...
        u(this, void 0, void 0, (function() {
            ...
            return l(this, (function(s) {
                ...
                case 0:
                    return e = jt(t),
                    o = !0,
                    e.modelUrl ? (o = "string" == typeof e.modelUrl && e.modelUrl.indexOf("https://tfhub.dev") > -1,
                    [4, i.loadGraphModel(e.modelUrl, {
                        fromTFHub: o
                    })]) : [3, 2];
                case 1:
                    return r = s.sent(),
    ...
    function oe(t, e, n, i, r, o) {
        for (var a = o.shape, s = a[0], u = a[1], l = !0, h = Math.max(n - r, 0), c = Math.min(n + r + 1, s), p = h; p < c; ++p) {
            for (var d = Math.max(i - r, 0), f = Math.min(i + r + 1, u), m = d; m < f; ++m)
                if (o.get(p, m, t) > e) {
                    l = !1;
                    break
                }
    ...
    function ye(t, e, n, i, r, o, a, s) {
        void 0 === s && (s = 2);
        for (var u = i.shape, l = u[0], h = u[1], p = {
            y: e.y,
            x: e.x
        }, d = ge(p, function(t, e, n) {
            var i = n.shape[2] / 2;
            return {
                y: n.get(e.y, e.x, t),
                x: n.get(e.y, e.x, i + t)
            }
        }(t, me(p, o, l, h), a)), f = 0; f < s; f++) {
            var m = me(d, o, l, h)
              , g = se(m.y, m.x, n, r);
            d = ge({
                x: m.x * o,
        ...
        u(this, void 0, void 0, (function() {
            ...
            return l(this, (function(l) {
                ...
                case 1:
                    ...
                    g = s * s; f.length < o && !m.empty(); )
                        y = m.dequeue(),
                        v = ue(y.part, r, c),
                        le(f, g, v, y.part.id) || (x = ve(y, h, c, r, p, d),
                        w = xe(f, g, x),
                        f.push({
                            keypoints: x,
                            score: w
    ...
    var be = function() {
        function t(t) {
            ...
            this.dispatchLayout = r.webgpu_util.flatDispatchLayout(this.outputShape),
            this.dispatch = r.webgpu_util.computeDispatch(this.dispatchLayout, this.outputShape, this.workgroupSize),
    ...
    var Se = function() {
        function t(t) {
            if (this.variableNames = ["A", "B"],
            this.size = !0,
            this.supportedLastDimension = 2,
            2 !== t.length || t[1] !== this.supportedLastDimension)
                throw new Error("GetOffsetVectorsProgram only supports shape of [x, ".concat(this.supportedLastDimension, "], but current shape is ").concat(t));
            this.workgroupSize = [32, 1, 1],
            this.outputShape = t;
            var e = [t[0], 1];
            this.dispatchLayout = r.webgpu_util.flatDispatchLayout(e),
            this.dispatch = r.webgpu_util.computeDispatch(this.dispatchLayout, e, this.workgroupSize),
    ...
    function Pe(t) {
        var e = t.shape
          ...
          , o = e[2];
        return n.tidy((function() {
            var e, a, s = n.reshape(t, [i * r, o]), u = n.argMax(s, 0), l = n.expandDims(n.div(u, n.scalar(r, "int32")), 1), h = n.expandDims((e = u,
            a = r,
            n.tidy((function() {
    ...
    function Fe(t, e, i) {
        return n.tidy((function() {
            ...
            return n.add(n.cast(n.mul(t.toTensor(), n.scalar(e, "int32")), "float32"), r)
        }
        ))
    }
    function _e(t, e, n, i) {
        ...
        return u(this, void 0, void 0, (function() {
            ...
            return l(this, (function(s) {
                ...
                o = function(t, e, i) {
                    return n.tidy((function() {
                        var r = Te(t, i);
                        return n.add(n.cast(n.mul(t, n.scalar(e, "int32")), "float32"), r)
                    }
                    ))
                }(r, i, e),
                a = Me(t, r),
    ...
    var Ae = "https://storage.googleapis.com/tfjs-models/savedmodel/posenet/mobilenet/"
      , Ce = "https://storage.googleapis.com/tfjs-models/savedmodel/posenet/resnet50/";
    function Ee(t, e) {
        return function(t, e) {
            return (t - 1) % e == 0
    ...
    var Re = function() {
        function t(t, e) {
            ...
            n.util.assert(-1 === i[1] && -1 === i[2], (function() {
                return "Input shape [".concat(i[1], ", ").concat(i[2], "] ") + "must both be equal to or -1"
            }
            ));
            var r, o, a = (r = e.inputResolution,
            o = e.outputStride,
            {
                height: Ee(r.height, o),
                width: Ee(r.width, o)
            });
            !function(t) {
            ...
            u(this, void 0, void 0, (function() {
                ...
                return l(this, (function(l) {
                    ...
                    case 0:
                        return r = function(t) {
                            var e = t;
                            if (null == e.maxPoses && (e.maxPoses = 1),
                            e.maxPoses <= 0)
                                throw new Error("Invalid maxPoses ".concat(e.maxPoses, ". Should be > 0."));
                            if (e.maxPoses > 1) {
                                if ((e = s(s({}, ee), e)).scoreThreshold < 0 || e.scoreThreshold > 1)
                                    throw new Error("Invalid scoreThreshold ".concat(e.scoreThreshold, ". ") + "Should be in range [0.0, 1.0]");
                                if (e.nmsRadius <= 0)
                                    throw new Error("Invalid nmsRadius ".concat(e.nmsRadius, "."))
                            }
                            return e
                        }(e),
                        null == t ? [2, i ? [[], []] : []] : (this.maxPoses = r.maxPoses,
                        o = V(t, {
                        ...
                        a = o.imageTensor,
                        u = o.padding,
                        h = "ResNet50" === this.architecture ? n.add(a, ne) : B(a, [-1, 1]),
                        c = this.posenetModel.predict(h),
                        "ResNet50" === this.architecture ? (p = n.squeeze(c[2], [0]),
                        d = n.squeeze(c[3], [0]),
                        f = n.squeeze(c[0], [0]),
                        m = n.squeeze(c[1], [0])) : (p = n.squeeze(c[0], [0]),
                        d = n.squeeze(c[1], [0]),
                        f = n.squeeze(c[2], [0]),
                        m = n.squeeze(c[3], [0])),
                        g = n.sigmoid(d),
                        1 !== this.maxPoses ? [3, 5] : i ? [4, Oe(g, p, this.outputStride)] : [3, 2]);
                    case 1:
                        return v = l.sent(),
                        w = v[0],
                        x = v[1],
                    ...
                    case 5:
                        ...
                        return [4, we(g, p, f, m, this.outputStride, this.maxPoses, r.scoreThreshold, r.nmsRadius)];
                    case 6:
                        y = l.sent(),
                        l.label = 7;
                    case 7:
                        if (i) {
                            ...
                            r.flipHorizontal && (b = function(t, e) {
                                for (var n = 0, i = t; n < i.length; n++)
                                    for (var r = 0, o = i[n].keypoints; r < o.length; r++) {
                                        var a = o[r];
                                        a.x = e.width - 1 - a.x
                                    }
                                return t
            ...
            return l(this, (function(s) {
                ...
                case 0:
                    return "ResNet50" !== (e = function(t) {
                        var e = t || Yt;
                        if (null == e.architecture && (e.architecture = "MobileNetV1"),
                        Wt.indexOf(e.architecture) < 0)
                            throw new Error("Invalid architecture ".concat(e.architecture, ". ") + "Should be one of ".concat(Wt));
                        ...
                        Qt[e.architecture].indexOf(e.outputStride) < 0)
                            throw new Error("Invalid outputStride ".concat(e.outputStride, ". ") + "Should be one of ".concat(Qt[e.architecture], " ") + "for architecture ".concat(e.architecture, "."));
                        if (null == e.multiplier && (e.multiplier = 1),
                        $t[e.architecture].indexOf(e.multiplier) < 0)
                            throw new Error("Invalid multiplier ".concat(e.multiplier, ". ") + "Should be one of ".concat($t[e.architecture], " ") + "for architecture ".concat(e.architecture, "."));
                        if (null == e.quantBytes && (e.quantBytes = 4),
                        Jt.indexOf(e.quantBytes) < 0)
                            throw new Error("Invalid quantBytes ".concat(e.quantBytes, ". ") + "Should be one of ".concat(Jt, " ") + "for architecture ".concat(e.architecture, "."));
                        if ("MobileNetV1" === e.architecture && 32 === e.outputStride && 1 !== e.multiplier)
                            throw new Error("When using an output stride of 32, you must select 1 as the multiplier.");
                        return e
                    }(t)).architecture ? [3, 2] : (u = e.outputStride,
                    l = e.quantBytes,
                    h = "model-stride".concat(u, ".json"),
                    n = 4 === l ? Ce + "float/" + h : Ce + "quant".concat(l, "/") + h,
                ...
                case 2:
                    return o = function(t, e, n) {
                        ...
                        return 4 === n ? Ae + "float/".concat(i[e], "/") + r : Ae + "quant".concat(n, "/").concat(i[e], "/") + r
    ...
    var Be = {
        keypointsToNormalizedKeypoints: tt
    }
      , Ve = {
        modelType: {

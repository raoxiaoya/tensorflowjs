...
!function(t, e) {
    ...
    var a = function() {
        ...
        return t.prototype.predict = function(t) {
            ...
            return e.tidy(function() {
                var n = r.preprocessInput(e.cast(t, "float32"))
                  , i = e.expandDims(n, 0)
                  , o = r.model.predict(i).map(function(t) {
                    return e.squeeze(t, [0])
                })
                  , u = r.nameOutputResults(o);
                return {
                    heatmapScores: e.sigmoid(u.heatmap),
                    offsets: u.offsets,
                    displacementFwd: u.displacementFwd,
                    displacementBwd: u.displacementBwd
                }
            })
        }
        ,
    ...
    function P(t) {
        var r = t.shape
          ...
          , o = r[2];
        return e.tidy(function() {
            var r, u, s = e.reshape(t, [n * i, o]), a = e.argMax(s, 0), l = e.expandDims(e.div(a, e.scalar(i, "int32")), 1), f = e.expandDims((r = a,
            u = i,
            e.tidy(function() {
                var t = e.div(r, e.scalar(u, "int32"));
                return e.sub(r, e.mul(t, e.scalar(u, "int32")))
            })), 1);
            return e.concat([l, f], 1)
        })
    }
    function B(t, e, r, n) {
        return {
    ...
    function q(t, r, n) {
        return e.tidy(function() {
            ...
            return e.add(e.cast(e.mul(t.toTensor(), e.scalar(r, "int32")), "float32"), i)
        })
    }
    function A(t, e, r) {
    ...
    var H = "https://storage.googleapis.com/tfjs-models/savedmodel/posenet/mobilenet/"
      , T = "https://storage.googleapis.com/tfjs-models/savedmodel/posenet/resnet50/";
    var V = [-123.15, -115.9, -103.06]
      , Y = function(t) {
        function r() {
            return null !== t && t.apply(this, arguments) || this
        }
    ...
    function J(t, r) {
        ...
        h = 0),
        {
            resized: e.tidy(function() {
                ...
                return r = e.pad3d(r, [[f, c], [p, h], [0, 0]]),
                e.image.resizeBilinear(r, [n, i])
            }),
            padding: {
                top: f,
                left: p,
            ...
            u(this, void 0, void 0, function() {
                ...
                return s(this, function(k) {
                    ...
                    case 1:
                        ...
                        _ = b[2],
                        S = b[3],
                        [4, N(w, x, _, S, n, r.maxDetections, r.scoreThreshold, r.nmsRadius)];
                    case 2:
                        return E = k.sent(),
            ...
            return s(this, function(s) {
                ...
                case 0:
                    ...
                    return o = function(t, e) {
                        ...
                        return 4 === e ? T + "float/" + r : T + "quant" + e + "/" + r
                    }(n, i),
            ...
            return s(this, function(e) {
                return "ResNet50" === (t = function(t) {
                    ...
                    tt[t.architecture].indexOf(t.outputStride) < 0)
                        throw new Error("Invalid outputStride " + t.outputStride + ". Should be one of " + tt[t.architecture] + " for architecture " + t.architecture + ".");
                    if (null == t.multiplier && (t.multiplier = 1),
                    et[t.architecture].indexOf(t.multiplier) < 0)
                        throw new Error("Invalid multiplier " + t.multiplier + ". Should be one of " + et[t.architecture] + " for architecture " + t.architecture + ".");
                    if (null == t.quantBytes && (t.quantBytes = 4),
                    rt.indexOf(t.quantBytes) < 0)
                        throw new Error("Invalid quantBytes " + t.quantBytes + ". Should be one of " + rt + " for architecture " + t.architecture + ".");
